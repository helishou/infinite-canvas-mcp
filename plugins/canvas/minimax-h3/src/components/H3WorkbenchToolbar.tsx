...
export function H3WorkbenchToolbar({ ctx, metadata, segments, selected, selectedIndex, outputs, playhead, total, fmt, onOpenStoryboard, onPlayAll }: Props) {
    ...
    return <>
        ...
        <div className="minimax-wb-toolbar">
            ...
            <div className="minimax-transport"><button type="button" title="连续播放全部 Clip" onClick={onPlayAll}><H3Icon name="play" /></button><button type="button" title="新增片段" onClick={addSegment}><H3Icon name="plus" /></button></div>
