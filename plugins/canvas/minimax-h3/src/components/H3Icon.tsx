...
import { Activity, Clapperboard, Database, Download, Film, Focus, Link2, ListFilter, Maximize2, MessageSquareText, Paperclip, Play, Plus, RotateCcw, Settings, SlidersHorizontal, Sparkles, X } from "lucide-react";

export type H3IconName = "clapperboard" | "play" | "plus" | "download" | "settings" | "database" | "folder" | "output" | "restore" | "sparkles" | "paperclip" | "waves" | "link2" | "trash" | "close" | "prompt" | "sliders" | "filter-all" | "filter-current" | "zoom";
