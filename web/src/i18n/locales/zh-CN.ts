export default {
    ...
    canvas: {
        ...
        loopNode: { title: "循环", count: "循环次数", serial: "串行", parallel: "并行", prompt: "提示词", image: "图片", video: "视频", start: "起始序号", batchSize: "每轮数量", promptPlaceholder: "可选：使用《计数》《总数》《进度》作为变量", inputHint: "连接上游输入后，按轮次选择提示词、图片或视频", run: "运行循环", stop: "停止循环", running: "第 {{current}} / {{total}} 轮", noTarget: "请先把循环节点连接到可生成节点", noInput: "请至少开启一种输入，或填写循环提示词" },
        projectPage: {
