export default {
    ...
    assets: {
        title: "我的资产",
        description: "按剧目管理角色、图片、视频、音频和文本资产，制作时快速查找复用。",
        ...
        kinds: { text: "文本", image: "图片", video: "视频", audio: "音频", character: "角色", scene: "场景" },
        fields: {
            title: "标题",
            titleRequired: "请输入标题",
            ...
            sceneDescriptionPlaceholder: "描述场景的空间、时间、氛围和关键元素",
            sceneImage: "场景图",
            sceneColorCard: "场景色卡",
            sceneColorCardPrompt: "色卡提示词（需列 HEX 色号）",
            sceneColorCardPromptPlaceholder: "按色块写颜色名与 HEX 色号，如：主色 青灰 #758A88；辅色 旧铜金 #A87545；点缀色 朱砂红 #B5483A，再描述光线与材质。",
        },
        ...
        noSceneColorCardSelected: "未选择场景色卡",
        sceneRequireImage: "场景资产至少需要一张场景图",
        sceneImageRequired: "请先添加场景图",
        sceneNoColorCard: "未添加场景色卡",
        preview: "预览",
        noCover: "暂无封面",
        untitled: "未命名资产",
        noTags: "无标签",
        ...
        character: {
            ...
            addImage: "添加参考图",
            downloadImages: "下载全部图片",
            defaultImage: "默认形象",
            setDefaultImage: "设为默认形象",
            voiceDescriptionPlaceholder: "描述音色、语气、年龄感和说话特点",
            previewVoice: "试听声线",
            stopVoicePreview: "停止试听",
            voicePreviewFailed: "声线预览播放失败",
        },
    },
    backend: {
    ...
    drama: {
        eyebrow: "短剧制作台",
        title: "把场景组织成一部短剧",
        intro: "场景图继续留在画布里，这里负责把它们按剧目编排、浏览和推进。",
        createProject: "新建剧目",
        createProjectPrompt: "请输入剧目名称",
        defaultProjectName: "新短剧",
        editProject: "编辑剧目资料",
        saveProject: "保存资料",
        deleteProject: "删除剧目",
        deleteProjectDescription: "确定删除「{{name}}」吗？剧目下的场景画布会保留并回到待编排场景。",
        deleteProjectConfirm: "确认删除",
        deleted: "剧目已删除",
        projectProfile: "剧目资料",
        projectName: "剧目名称",
        outline: "故事大纲",
        outlinePlaceholder: "写下故事主线、人物关系和关键冲突…",
        description: "一句话简介",
        descriptionPlaceholder: "用一句话说明这部短剧讲什么…",
        tags: "标签",
        tagsPlaceholder: "用逗号分隔，例如：悬疑，都市，反转",
        uploadCover: "上传封面",
        changeCover: "更换封面",
        coverUploadFailed: "封面上传失败",
        saved: "剧目资料已保存",
        outlineEmpty: "还没有填写故事大纲",
        overview: "制作总览",
        allScenes: "全部场景",
        unfiled: "待编排场景",
        projects: "剧目",
        libraryTitle: "全部剧目",
        libraryDescription: "选择一个剧目，进入后管理分集、画布和剧目资产。",
        detailDescription: "管理这个剧目的分集、画布与共享资产。",
        backToProjects: "返回剧目列表",
        enterProject: "进入剧目",
        emptyProjectsTitle: "还没有剧目",
        emptyProjectsDescription: "先新建一个剧目，再按集整理剧情与画布。",
        episodes: "分集",
        episodeListTitle: "分集列表",
        episodeUnit: "集",
        episodeCount: "{{count}} 集",
        boundCanvasCount: "已绑定 {{count}} 个画布",
        newEpisode: "新建分集",
        editEpisode: "编辑分集",
        saveEpisode: "保存分集",
        episodeNumber: "集数",
        ...
        episodeTitle: "分集标题",
        episodeTitlePlaceholder: "例如：退婚夜",
        episodeSynopsis: "分集剧情 / 梗概",
        episodeSynopsisPlaceholder: "这集发生了什么，关系发生了什么变化，结尾落点是什么",
        episodeFullPlot: "完整剧情",
        episodeFullPlotPlaceholder: "填写本集从开场到结尾的完整剧情，可包含场景推进、人物行动、冲突转折和关键对白",
        bindCanvas: "绑定画布",
        unboundCanvas: "待绑定画布",
        canvasActions: "画布方式",
        noCanvas: "暂不绑定画布",
        createAndBindCanvas: "新建并绑定画布",
        existingCanvases: "绑定已有画布",
        canvasCreateFailed: "新画布创建失败",
        noEpisodeSynopsis: "暂无分集剧情",
        episodeCreated: "分集已创建",
        episodeSaved: "分集已保存",
        episodeDeleted: "分集已删除",
        episodeSaveFailed: "保存分集失败",
        episodeDeleteFailed: "删除分集失败",
        deleteEpisodeTitle: "删除分集？",
        deleteEpisodeDescription: "将删除“{{name}}”的分集记录，但不会删除绑定画布。",
        scenes: "场景画布",
        scene: "画布场景",
        nodes: "个节点",
        connections: "条连线",
        updated: "更新于 {{date}}",
        emptyTitle: "还没有可编排的场景",
        emptyDescription: "先在画布库创建场景图，再回到这里组织成短剧。",
        emptyFolderTitle: "这个剧目还没有分集",
        emptyFolderDescription: "新建第一集，可以暂不绑定画布、绑定已有画布或直接创建新画布。",
        folderHint: "文件夹会作为剧目使用，画布本身仍是场景编辑器。",
    ...
    canvas: {
        ...
        folder: { title: "文件夹", all: "全部画布", unfiled: "未分类", newFolder: "新建文件夹", rename: "重命名文件夹", renameAction: "重命名", deleteAction: "删除文件夹", deleteDescription: "删除文件夹后，其中的画布会移到未分类。继续吗？", move: "移动到", moveRoot: "移出文件夹" },
        collapsePanel: "收起面板",
        expandPanel: "展开面板",
        home: "主页",
        docs: "文档",
        ...
        project: {
            ...
            select: "选择 {{name}}", stats: "{{nodes}} 个节点 · {{connections}} 条连线", updated: "更新于 {{date}}", saveName: "保存名称", cancelRename: "取消重命名", export: "导出", rename: "重命名", delete: "删除", moveFolder: "移动文件夹",
        ...
        createMenu: {
            fromNode: "引用该节点生成", blank: "新建节点", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "图片生成", video: "视频生成", audio: "音频参考", config: "智能生成", configDescription: "提示词、模型、参数和结果合并在一个节点", loop: "循环", loopDescription: "按轮次选择输入并运行下游节点", select: "选择节点",
        },
        node: {
            node: "节点",
        ...
        character: {
            ...
            editTitle: "编辑角色",
            editName: "角色名",
            editNamePlaceholder: "如：Sarah / Sarah·冬日披风",
            editDescription: "描述",
            editDescriptionPlaceholder: "一句话描述这个角色（背景、特征等）",
            editImages: "参考图",
            addImageFromCanvas: "从画布添加",
            replaceImageFromCanvas: "从画布替换",
            selectingImageHint: "从画布选择图片节点 · ESC 返回编辑",
            editVoicePlaceholder: "从音频资产选或上传本地文件",
            editPickVoiceAsset: "从音频资产库选择声线",
            convertNoImage: "只能把有图片内容的节点转为角色节点",
            converted: "已转为角色节点",
        ...
        scene: {
            ...
            addFromCanvas: "从画布添加",
            colorPalette: "HEX 色号",
            reextractColorPalette: "重新提取",
            addPaletteColor: "添加色号",
            emptyColorPalette: "尚未提取色号，可手动添加或重新提取",
            colorHexPlaceholder: "#RRGGBB",
            colorHexLabel: "颜色 {{index}} HEX 色号",
            removePaletteColor: "删除色号",
            colorPaletteEmptyResult: "未识别到色号，请手动添加。",
            colorPaletteExtractFailed: "无法读取色卡色号，请检查图片格式。",
            editTitle: "编辑场景",
            name: "场景名称",
            namePlaceholder: "输入场景名称",
            description: "场景描述",
            descriptionPlaceholder: "描述场景的空间、时间、氛围和关键元素",
            colorCardPrompt: "色卡提示词（需列 HEX 色号）",
            colorCardPromptPlaceholder: "按色块写颜色名与 HEX 色号，如：主色 青灰 #758A88；辅色 旧铜金 #A87545；点缀色 朱砂红 #B5483A，再描述光线与材质。",
            selectingImageHint: "从画布选择图片节点 · ESC 返回编辑",
            saveNameRequired: "请先在节点标题填写场景名",
            saveToAssetsSuccess: "已保存为场景资产（替换同名）",
            saveToAssetsFailed: "保存失败：{{error}}",
        ...
        sidePanel: {
            ...
            searchPrompts: "搜索提示词", addPrompt: "新增提示词", noPrompts: "暂无提示词", promptCopied: "已复制提示词", copyFailed: "复制失败", loadFailedRetry: "加载失败，点击重试", noMatchingPrompts: "无匹配提示词", sourceEmpty: "该来源暂无提示词", customEmpty: "还没有自定义提示词，点上方 + 新增一条吧", viewDetails: "查看详情",
        ...
        videoCompare: { open: "对比", title: "视频同屏对比", selectingHint: "点击画布中的视频节点进行对比 · Esc 取消", selectingSource: "当前视频", chooseNode: "点击选择对比视频", choose: "添加更多画布视频", placeholder: "搜索并添加视频节点", noCandidates: "画布中没有其他视频", source: "当前视频", play: "播放全部", pause: "暂停全部", seek: "对齐播放进度", loadFailed: "视频加载失败", hint: "所有视频按同一时间点播放；较短视频结束后停在末帧。对比视频静音，仅播放当前视频声音。" },
        ...
        loopNode: { title: "循环", count: "循环次数", auto: "自动", serial: "串行", parallel: "并行", prompt: "提示词", image: "图片", video: "视频", start: "起始序号", batchSize: "每轮数量", defaultPrompt: "现在生成第《计数》张卖点图片", videoHistory: "视频历史", currentResult: "当前结果", historyResult: "历史结果 {{count}}", upstreamPrompts: "已连接 {{count}} 条上游提示词", addPrompt: "新增提示词", removePrompt: "删除提示词", counterToken: "《计数》", promptPlaceholder: "可选：使用《计数》《总数》《进度》作为变量", inputHint: "按轮次执行下游链路，可选提示词或素材输入", run: "运行循环", stop: "停止循环", running: "已完成 {{current}} / {{total}} 轮", noTarget: "请先把循环节点连接到可生成节点", noInput: "循环和下游节点都没有可用输入或提示词", noMediaAtStart: "起始序号超出素材数量，没有可运行的轮次", mixedMedia: "循环节点不能同时传入图片和视频，请拆分为同类型素材组", mediaMismatch: "循环节点的输入类型与已开启的图片或视频类型不一致", parallelMediaOnly: "并行轮次仅支持图片或视频生成链；请切换串行或调整下游节点", videoToImageUnsupported: "图片生成节点不能直接使用循环中的视频结果，请改接视频生成节点" },
        projectPage: {
        ...
        editors: {
            ...
            splitTitle: "切分图片", splitDescription: "生成 {{count}} 个图片子节点，并按原图网格排列到画布右侧", splitHint: "滚轮缩放 · 中键或空格+左键拖动画面 · Delete 删除选中线 · Ctrl/Cmd+Z 撤回 · Ctrl/Cmd+Shift+Z 重做", undoSplitTitle: "撤回切图调整 (Ctrl/Cmd+Z)", undoSplit: "撤回切图调整", redoSplitTitle: "重做切图调整 (Ctrl/Cmd+Shift+Z)", redoSplit: "重做切图调整", rows: "行数", columns: "列数", lineWidth: "切分线宽度", lineWidthHint: "仅影响预览里切分线的视觉粗细，不改变实际切割位置", horizontalLine: "横向线", verticalLine: "纵向线", deleteLine: "删除线", resetLines: "重置线", pieceCount: "切片数量", pieces: "{{count}} 个", averageSize: "平均约", generateChildren: "生成子节点",
        },
        ...
        controls: { ratio: "比例", duplicate: "复制", copyContent: "复制内容", delete: "删除", group: "生成组", images: "{{count}} 张", texts: "{{count}} 条", generations: "{{count}} 次", reasoning: "推理" },
        ...
        agentOps: { add_node: "新增节点", update_node: "更新节点", delete_node: "删除节点", delete_connections: "删除连线", connect_nodes: "连接", create_group: "生成组", select_nodes: "选择节点", run_generation: "触发生成" },
