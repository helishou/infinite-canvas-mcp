export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "图片", text: "文本", config: "智能生成", video: "视频", audio: "音频", loop: "循环", group: "组", character: "角色" },
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "智能生成", loop: "循环", character: "角色", group: "组", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", clear: "清空画布", arrange: "整理布局",
        ...
        createMenu: {
            fromNode: "引用该节点生成", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "图片生成", video: "视频生成", audio: "音频参考", config: "智能生成", configDescription: "提示词、模型、参数和结果合并在一个节点", loop: "循环", loopDescription: "按轮次选择输入并运行下游节点", select: "选择节点",
        },
        node: {
            node: "节点",
        ...
        sidePanel: {
            ...
            filter: { image: "图片", video: "视频", text: "文本", audio: "音频", config: "配置", loop: "循环", character: "角色", group: "分组" },
        },
        ...
        agentOps: { add_node: "新增节点", update_node: "更新节点", delete_node: "删除节点", delete_connections: "删除连线", connect_nodes: "连接", select_nodes: "选择节点", run_generation: "触发生成" },
