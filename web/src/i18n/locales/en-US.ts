export default {
    ...
    canvas: {
        ...
        loopNode: { title: "Loop", count: "Iterations", auto: "Auto", serial: "Serial", parallel: "Parallel", prompt: "Prompt", image: "Images", video: "Videos", audioInput: "Audio", start: "Start index", batchSize: "Per-round count", defaultPrompt: "Generate result for round 《计数》", videoHistory: "Video history", currentResult: "Current result", historyResult: "History {{count}}", upstreamPrompts: "{{count}} upstream prompts connected", addPrompt: "Add prompt", removePrompt: "Remove prompt", counterToken: "《计数》", promptPlaceholder: "Optional: use 《计数》《总数》《进度》 as variables", inputHint: "Rounds follow input order; outputs are grouped on the right", run: "Run loop", stop: "Stop loop", running: "{{current}} / {{total}} rounds completed", noTarget: "The loop prepares its output group automatically", noInput: "Set a generation prompt or connect usable inputs", noMediaAtStart: "Start index is beyond the input count; there are no rounds to run", mixedMedia: "A loop input group can use one media type at a time", mediaMismatch: "The input media type is incompatible with the selected output mode", parallelMediaOnly: "Parallel rounds support independent tasks in every output mode", videoToImageUnsupported: "Image generation cannot use loop video input directly" },
        projectPage: {
