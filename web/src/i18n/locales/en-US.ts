export default {
    ...
    canvas: {
        ...
        loopNode: { title: "Loop", count: "Iterations", serial: "Serial", parallel: "Parallel", prompt: "Prompt", image: "Images", video: "Videos", start: "Start index", batchSize: "Per-round count", promptPlaceholder: "Optional: use 《计数》《总数》《进度》 as variables", inputHint: "Connect inputs to select prompts, images, or videos by round", run: "Run loop", stop: "Stop loop", running: "Round {{current}} / {{total}}", noTarget: "Connect the loop to a generative node first", noInput: "Enable at least one input or enter a loop prompt" },
        projectPage: {
