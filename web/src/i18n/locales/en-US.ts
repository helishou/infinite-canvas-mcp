export default {
    ...
    drama: {
        ...
        openCanvasLibrary: "Manage canvases",
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Smart generation", video: "Video", audio: "Audio", loop: "Loop", group: "Group", character: "Character" },
        toolbar: {
            select: "Select", pan: "Move", text: "Text", image: "Image", video: "Video", audio: "Audio", config: "Smart generation", loop: "Loop", character: "Character", group: "Group", extensions: "Extension nodes", upload: "Upload assets", appearance: "Canvas appearance", clear: "Clear canvas", arrange: "Arrange",
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Smart generation", configDescription: "Prompt, model, parameters, and result in one node", loop: "Loop", loopDescription: "Select inputs by round and run downstream nodes", select: "Select a node",
        },
        node: {
            node: "Node",
        ...
        sidePanel: {
            ...
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", config: "Configuration", loop: "Loop", character: "Character", group: "Group" },
        },
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", saveAsset: "Save asset", convertToCharacter: "Convert to character", saveCharacterToAsset: "Save as character asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
        ...
        agentOps: { add_node: "Add node", update_node: "Update node", delete_node: "Delete node", delete_connections: "Delete connections", connect_nodes: "Connect", select_nodes: "Select nodes", run_generation: "Run generation" },
