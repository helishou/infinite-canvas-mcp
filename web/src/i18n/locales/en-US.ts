export default {
    ...
    assets: {
        title: "My Assets",
        description: "Organize characters, images, video, audio, and text by drama for quick reuse during production.",
        ...
        drama: {
            ...
            assign: "Assign drama",
            moved: "Updated the drama for {{count}} asset(s)",
        },
        ...
        kinds: { text: "Text", image: "Image", video: "Video", audio: "Audio", character: "Character", scene: "Scene" },
        fields: {
            title: "Title",
            ...
            sceneDescriptionPlaceholder: "Describe the space, time, atmosphere, and key elements",
            sceneImage: "Scene image",
            sceneColorCard: "Scene color card",
            sceneColorCardPrompt: "Color card prompt (include HEX codes)",
            sceneColorCardPromptPlaceholder: "List each swatch with its name and HEX code, e.g. Main blue-gray #758A88; secondary antique brass #A87545; accent vermilion #B5483A. Then describe lighting and materials.",
        },
        ...
        noSceneColorCardSelected: "No scene color card selected",
        sceneRequireImage: "A scene asset needs at least one scene image",
        sceneImageRequired: "Add a scene image first",
        sceneNoColorCard: "No scene color card added",
        preview: "Preview",
        noCover: "No cover",
        ...
        character: {
            ...
            defaultImage: "Default look",
            setDefaultImage: "Set as default look",
            voiceDescriptionPlaceholder: "Describe the tone, delivery, apparent age, and speaking style",
            previewVoice: "Preview voice",
            stopVoicePreview: "Stop preview",
            voicePreviewFailed: "Could not play the voice preview",
        },
    },
    backend: {
    ...
    drama: {
        eyebrow: "Short Drama Desk",
        title: "Shape scenes into a production",
        intro: "Keep scene boards in Canvas; use this space to organize, browse, and move a drama forward.",
        createProject: "New drama",
        createProjectPrompt: "Name this drama",
        defaultProjectName: "New short drama",
        editProject: "Edit drama profile",
        saveProject: "Save profile",
        deleteProject: "Delete drama",
        deleteProjectDescription: "Delete “{{name}}”? Its scene canvases will be kept and returned to unfiled scenes.",
        deleteProjectConfirm: "Delete",
        deleted: "Drama deleted",
        projectProfile: "Drama profile",
        projectName: "Drama name",
        outline: "Story outline",
        outlinePlaceholder: "Write the story spine, character relationships, and central conflict…",
        description: "One-line description",
        descriptionPlaceholder: "Describe what this short drama is about in one sentence…",
        tags: "Tags",
        tagsPlaceholder: "Comma-separated, e.g. mystery, urban, twist",
        uploadCover: "Upload cover",
        changeCover: "Change cover",
        coverUploadFailed: "Cover upload failed",
        saved: "Drama profile saved",
        outlineEmpty: "No story outline yet",
        overview: "Production overview",
        allScenes: "All scenes",
        unfiled: "Unfiled scenes",
        projects: "Dramas",
        libraryTitle: "All dramas",
        libraryDescription: "Choose a drama to manage its episodes, canvases, and shared assets.",
        detailDescription: "Manage this drama's episodes, canvases, and shared assets.",
        backToProjects: "Back to dramas",
        enterProject: "Open drama",
        emptyProjectsTitle: "No dramas yet",
        emptyProjectsDescription: "Create a drama first, then organize its plot and canvases episode by episode.",
        episodes: "Episodes",
        episodeListTitle: "Episode list",
        episodeUnit: "episodes",
        episodeCount: "{{count}} episodes",
        boundCanvasCount: "{{count}} canvases bound",
        ...
        episodeTitlePlaceholder: "e.g. The Broken Engagement",
        episodeSynopsis: "Episode synopsis",
        episodeSynopsisPlaceholder: "What happens in this episode, what relationship changes, and where does it land?",
        episodeFullPlot: "Full plot",
        episodeFullPlotPlaceholder: "Write the complete episode from opening to ending, including scene progression, character actions, conflict turns, and key dialogue.",
        bindCanvas: "Bind canvas",
        unboundCanvas: "No canvas bound",
        canvasActions: "Canvas option",
        noCanvas: "Do not bind a canvas",
        createAndBindCanvas: "Create and bind a new canvas",
        existingCanvases: "Bind an existing canvas",
        canvasCreateFailed: "Failed to create the new canvas",
        noEpisodeSynopsis: "No episode synopsis yet",
        episodeCreated: "Episode created",
        episodeSaved: "Episode saved",
        episodeDeleted: "Episode deleted",
        episodeSaveFailed: "Failed to save episode",
        episodeDeleteFailed: "Failed to delete episode",
        deleteEpisodeTitle: "Delete episode?",
        deleteEpisodeDescription: "Delete the episode record for “{{name}}”? Its bound canvas will not be deleted.",
        scenes: "Scene canvases",
        scene: "Canvas scene",
        nodes: "nodes",
        connections: "connections",
        updated: "Updated {{date}}",
        emptyTitle: "No scenes to arrange yet",
        emptyDescription: "Create scene boards in Canvas, then return here to organize them into a drama.",
        emptyFolderTitle: "This drama has no episodes yet",
        emptyFolderDescription: "Create the first episode without a canvas, bind an existing one, or create a new canvas directly.",
        folderHint: "Folders act as dramas here; the canvas remains the scene editor.",
        customAssets: { eyebrow: "Drama-level files", title: "Custom assets", description: "LUTs, fonts, scripts, reference documents, and asset packages shared by the whole drama.", upload: "Upload assets", empty: "No drama-level custom assets yet", loadFailed: "Failed to load drama assets", uploadFailed: "Failed to upload drama assets", uploaded: "Uploaded {{count}} drama assets", deleteTitle: "Delete drama asset", deleteDescription: "Delete “{{name}}”?", deleted: "Drama asset deleted", download: "Download asset", delete: "Delete asset" },
        stats: {
            dramas: "Dramas",
            scenes: "Scene canvases",
            drafted: "With content",
            episodes: "Episodes",
            boundCanvases: "Bound canvases",
        },
    },
    canvas: {
        ...
        folder: { title: "Folders", all: "All canvases", unfiled: "Unfiled", newFolder: "New folder", rename: "Rename folder", renameAction: "Rename", deleteAction: "Delete folder", deleteDescription: "Canvases in this folder will move to Unfiled. Continue?", move: "Move to", moveRoot: "Remove from folder" },
        ...
        project: {
            ...
            select: "Select {{name}}", stats: "{{nodes}} nodes · {{connections}} connections", updated: "Updated {{date}}", saveName: "Save name", cancelRename: "Cancel rename", export: "Export", rename: "Rename", delete: "Delete", moveFolder: "Move folder",
        ...
        createMenu: {
            fromNode: "Generate from this node", blank: "Create node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Smart generation", configDescription: "Prompt, model, parameters, and result in one node", loop: "Loop", loopDescription: "Select inputs by round and run downstream nodes", select: "Select a node",
        },
        node: {
            node: "Node",
        ...
        character: {
            ...
            editName: "Name",
            editNamePlaceholder: "e.g. Sarah / Sarah · Winter Cloak",
            editDescription: "Description",
            editDescriptionPlaceholder: "Brief description of this character (background, traits, etc.)",
            editImages: "Reference images",
            addImageFromCanvas: "Add from canvas",
            replaceImageFromCanvas: "Replace from canvas",
            selectingImageHint: "Select an image node on the canvas · ESC to return",
            editVoicePlaceholder: "Pick from audio assets or upload a file",
            editPickVoiceAsset: "Pick voice from audio assets",
            convertNoImage: "Only image nodes with content can be converted to a character node",
            converted: "Converted to character node",
        ...
        scene: {
            ...
            addFromCanvas: "Add from canvas",
            colorPalette: "HEX colors",
            reextractColorPalette: "Re-extract",
            addPaletteColor: "Add color",
            emptyColorPalette: "No colors extracted yet. Add colors manually or re-extract.",
            colorHexPlaceholder: "#RRGGBB",
            colorHexLabel: "Color {{index}} HEX value",
            removePaletteColor: "Remove color",
            colorPaletteEmptyResult: "No color codes found. Add them manually.",
            colorPaletteExtractFailed: "Could not read color codes from this card. Check the image format.",
            editTitle: "Edit scene",
            name: "Scene name",
            namePlaceholder: "Enter the scene name",
            description: "Scene description",
            descriptionPlaceholder: "Describe the space, time, atmosphere, and key elements",
            colorCardPrompt: "Color card prompt (include HEX codes)",
            colorCardPromptPlaceholder: "List each swatch with its name and HEX code, e.g. Main blue-gray #758A88; secondary antique brass #A87545; accent vermilion #B5483A. Then describe lighting and materials.",
            selectingImageHint: "Select an image node on the canvas · ESC to return",
            saveNameRequired: "Set a scene name in the node title first",
            saveToAssetsSuccess: "Saved as scene asset (replaced by name)",
            saveToAssetsFailed: "Save failed: {{error}}",
            convertNoImage: "Only image nodes with content can be converted to a scene node",
            converted: "Converted to scene node",
        },
        videoFrames: { first: "Capture first frame", last: "Capture last frame", current: "Capture current frame", allShots: "Extract all shot keyframes", extracting: "Extracting keyframes…", firstTitle: "{{name}} first frame", lastTitle: "{{name}} last frame", currentTitle: "{{name}} current frame", shotTitle: "Shot {{index}}", shotGroupTitle: "{{name}} · {{count}} shots", extracted: "Extracted {{count}} shot keyframes", noShots: "No shot changes detected in this video", captured: "Image node created", failed: "Could not capture this frame. Try again." },
        sidePanel: {
            ...
            searchPrompts: "Search prompts", addPrompt: "Add prompt", noPrompts: "No prompts", promptCopied: "Prompt copied", copyFailed: "Copy failed", loadFailedRetry: "Load failed. Click to retry.", noMatchingPrompts: "No matching prompts", sourceEmpty: "No prompts from this source", customEmpty: "No custom prompts yet. Click + above to add one.", viewDetails: "View details",
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", config: "Configuration", loop: "Loop", character: "Character", scene: "Scene", group: "Group" },
        },
        assetPicker: { title: "Select assets", insert: "Insert", search: "Search assets", empty: "No assets" },
        imageTools: { copyPrompt: "Copy prompt", copyPromptTitle: "Copy the prompt used to generate this image", reversePrompt: "Reverse prompt", reversePromptTitle: "Create text and configuration nodes to infer the prompt", replace: "Replace image", locked: "Lock ratio", free: "Free ratio", lockTitle: "Switch to proportional scaling", freeTitle: "Switch to free resizing", mask: "Local edit", maskTitle: "Paint a mask and edit the selected area", crop: "Crop", cropTitle: "Crop into a new node", split: "Split", splitTitle: "Split the image by rows and columns", upscale: "Upscale", upscaleTitle: "Increase image resolution", superResolve: "Super resolution", superResolveTitle: "AI super resolution", autoLevels: "Auto levels", autoLevelsTitle: "Run the moyou auto-levels workflow", angle: "Multi-angle", angleTitle: "Generate another angle", view: "View image", viewTitle: "View image details", more: "More", configure: "Configure quick tools", customize: "Customize toolbar", showLabels: "Show button labels", description: "Choose the quick tools shown in the image-node toolbar.", preview: "Node preview", imageNode: "Image node", quickTools: "Quick tools" },
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", arrangeGroupTitle: "Resize the members to similar sizes and lay them out inside the group", arrangeGroup: "Arrange", retryTitle: "Generate again", saveAsset: "Save asset", convertToCharacter: "Convert to character", convertToScene: "Convert to scene", saveCharacterToAsset: "Save as character asset", saveSceneToAsset: "Save as scene asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
        videoCompare: { open: "Compare", title: "Side-by-side video comparison", choose: "Choose other videos on this canvas", placeholder: "Search and select video nodes", noCandidates: "No other videos on this canvas", source: "Current video", play: "Play all", pause: "Pause all", seek: "Aligned playback position", loadFailed: "Video failed to load", hint: "All videos play from the same time. Shorter videos hold their last frame. Comparison videos are muted; only the current video has sound." },
        configNode: { title: "Smart generation", image: "Image", text: "Text", video: "Video", audio: "Audio", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate" },
        loopNode: { title: "Loop", count: "Iterations", auto: "Auto", serial: "Serial", parallel: "Parallel", prompt: "Prompt", image: "Images", video: "Videos", start: "Start index", batchSize: "Per-round count", defaultPrompt: "Generate selling-point image 《计数》", videoHistory: "Video history", currentResult: "Current result", historyResult: "History {{count}}", upstreamPrompts: "{{count}} upstream prompts connected", addPrompt: "Add prompt", removePrompt: "Remove prompt", counterToken: "《计数》", promptPlaceholder: "Optional: use 《计数》《总数》《进度》 as variables", inputHint: "Run the downstream chain by round, with optional prompts or media inputs", run: "Run loop", stop: "Stop loop", running: "{{current}} / {{total}} rounds completed", noTarget: "Connect the loop to a generative node first", noInput: "The loop and downstream nodes have no usable input or prompt", noMediaAtStart: "Start index is beyond the available media; there are no rounds to run", mixedMedia: "A loop cannot accept images and videos together; use one media type per group", mediaMismatch: "The connected media type does not match the enabled image or video input", parallelMediaOnly: "Parallel rounds support image or video generation chains only; switch to serial or change the downstream nodes", videoToImageUnsupported: "An image generation node cannot use a loop video result directly; connect a video generation node" },
        projectPage: {
        ...
        controls: { ratio: "Ratio", duplicate: "Duplicate", copyContent: "Copy content", delete: "Delete", group: "Create group", images: "{{count}} images", texts: "{{count}} options", generations: "{{count}} runs", reasoning: "Reasoning" },
        ...
        agentOps: { add_node: "Add node", update_node: "Update node", delete_node: "Delete node", delete_connections: "Delete connections", connect_nodes: "Connect", create_group: "Create group", select_nodes: "Select nodes", run_generation: "Run generation" },
    ...
    config: {
        ...
        channelEditor: {
            ...
            selectWorkflows: "Select workflows",
