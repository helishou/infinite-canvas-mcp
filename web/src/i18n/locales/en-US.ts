export default {
    ...
    canvas: {
        ...
        controls: { ratio: "Ratio", duplicate: "Duplicate", delete: "Delete", group: "Create group", images: "{{count}} images", texts: "{{count}} options", generations: "{{count}} runs", reasoning: "Reasoning" },
