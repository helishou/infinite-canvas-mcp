...
import type { CanvasCharacterReferenceSelection } from "@/lib/canvas/canvas-resource-references";
...
export function CanvasConfigComposer({ nodeId, nodes, value, inputs, connectedNodes = [], onChange, onClose, onDisconnectReference, onStartReferenceSelection, onCharacterReferenceChange }: CanvasConfigComposerProps) {
    ...
    return (
        ...
        >
            ...
            <CanvasNodeReferenceBar nodeId={nodeId} nodes={nodes} connectedNodes={connectedNodes} onDisconnect={onDisconnectReference} onStartSelection={onStartReferenceSelection} onCharacterSelectionChange={onCharacterReferenceChange} />
