...
- Create, edit, and delete browser-local prompts with tags, cover images, and reference images; use them from the prompt center, canvas sidebar, and generation selectors.
